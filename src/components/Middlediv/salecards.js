...
export var saleList, setSaleListexport
...
function Salecards({ setActiveSection }) {
  ...
  async function displayCard() {
    ...
    setSaleList(saleList = <div className="loading-div">
    ...
    setTimeout(() => {
      ...
      else alert('Failed to load, timeout 15s');
    }, 20000);
  }
