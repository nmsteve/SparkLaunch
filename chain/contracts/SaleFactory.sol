...
contract SalesFactory is Ownable{
    ...
    {   require(msg.value >= fee, "Not enough bnb sent");
        SparklaunchSale sale = new SparklaunchSale(address(admin), serviceFee, feeAddr);
    ...
    function deployNormalSaleERC20()
    external 
    payable 
    {   require(msg.value >= fee, "Not enough bnb sent");
        SparklaunchSaleERC20 sale = new SparklaunchSaleERC20(address(admin), serviceFee, feeAddr);
