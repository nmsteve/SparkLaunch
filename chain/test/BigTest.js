...
describe("SparklaunchSale", function() {
  ...
  function participate(params) {
    ...
    return SparklaunchSale.connect(registrant).participate(participationAmount, participationRound, {value: value});
  }
  ...
  async function setSaleParams(params) {
    ...
    return await SparklaunchSale.setSaleParams(
        token, saleOwner, tokenPriceInBNB, saleEnd,
        hardCap, softCap
    );
  }
  ...
  context.only("Finish Sale", async function(){
